...
class AdminFactoryTest {
    ...
    void createAdmin_validData_returnsAdmin(){
        Admin admin = AdminFactory.createAdmin("A001", "john.doe", "SUPER_ADMIN", "READ_WRITE");
    ...
    void createAdmin_nullAdminId_returnsNull(){
        Admin admin = AdminFactory.createAdmin(null, "john.doe", "SUPER_ADMIN", "READ_WRITE");
        assertNull(admin);
    }
    ...
    void createAdmin_nullUser_returnsNull(){
        Admin admin = AdminFactory.createAdmin("A001", null, "SUPER_ADMIN", "READ_WRITE");
        assertNull(admin);
    }

    @Test
    void createAdmin_emptyUser_returnsNull(){
        Admin admin = AdminFactory.createAdmin("A001", "", "SUPER_ADMIN", "READ_WRITE");
        assertNull(admin);
    }

    @Test
    void createAdmin_nullRole_returnsNull(){
        Admin admin = AdminFactory.createAdmin("A001", "john.doe", null, "READ_WRITE");
        assertNull(admin);
    }

    @Test
    void createAdmin_emptyRole_returnsNull(){
        Admin admin = AdminFactory.createAdmin("A001", "john.doe", "   ", "READ_WRITE");
        assertNull(admin);
    }

    @Test
    void createAdmin_nullPermissions_returnsNull(){
        Admin admin = AdminFactory.createAdmin("A001", "john.doe", "SUPER_ADMIN", null);
        assertNull(admin);
    }
