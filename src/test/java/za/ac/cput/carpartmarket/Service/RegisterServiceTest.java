...
class RegisterServiceTest {
    ...
    public static void setUp() {
        buyer = BuyerFactory.createBuyer("BUYER001", NameFactory.createName("John", "Doe"), "Electronics");
    }
    ...
    void testReadNonExistent() {
        Register read = registerService.read("NON_EXISTENT");
        assertNull(read);
        System.out.println("Read non-existent: " + read);
    }
}